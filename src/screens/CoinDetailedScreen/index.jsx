...
const CoinDetailedScreen = () => {
  ...
  const [coinMarketData, setCoinMarketData] = useState(null);
    ...
    return (
        ...
        {/* <ChartPathProvider data={{ points: prices.map(([x, y]) => ({ x: price[0], y: price[1] })), smoothingStrategy: 'bezier' }}> */}
          ...
          />
            <View style={styles.priceContainer}>
              ...
              <AntDesign 
                ...
                <Text style={styles.priceChange} > {price_change_percentage_24h?.toFixed(2)}%
                </Text>
              </View>
            </View>  
